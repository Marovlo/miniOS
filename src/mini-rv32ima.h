			...
			switch( ir & 0x7f )
			{
				...
				case 0x73: // Zifencei+Zicsr  (0b1110011)
				{
					...
					if( (microop & 3) ) // It's a Zicsr function.
					{
						...
						default: MINIRV32_OTHERCSR_READ( csrno, rval ); break;
						}
						...
						default: MINIRV32_OTHERCSR_WRITE( csrno, writeval ); break;
						}
					}
					else if( microop == 0x0 ) // "SYSTEM" 0b000
					{
						...
						else
						{
							switch (csrno)
							{
							case 0: trap = ( CSR( extraflags ) & 3) ?  (11+1) : (8+1); break; // ECALL
							case 1:	trap = (3+1); break; // EBREAK
